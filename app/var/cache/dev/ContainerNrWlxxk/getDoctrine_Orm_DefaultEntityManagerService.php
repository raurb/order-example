 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends OrderExample_KernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostFb637da', static fn () => \EntityManagerGhostFb637da::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
