 ...
 */
class OrderExample_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'OrderExample\\Controller\\OrderController' => 'getOrderControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['OrderExample\\Kernel', 'OrderExample\\Controller\\OrderController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/OrderExample_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'OrderExample_KernelDevDebugContainer',
