 ...
 */
class getDoctrine_Orm_DefaultConfigurationService extends OrderExample_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity')], true)), 'OrderExample\\Entity');

        $instance->setEntityNamespaces(['OrderExample' => 'OrderExample\\Entity']);
